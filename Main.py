...
def importarLattes(lattes):
    ...
    service.processar(tagName='ATUACAO-PROFISSIONAL', tituloAttributeName='NOME-INSTITUICAO', anoAttributeName='ANO-INICIO', anoFimAttributeName='ANO-FIM'
    ...
    service.processar(tagName='TRABALHO-EM-EVENTOS', dadosBasicosTagName='DADOS-BASICOS-DO-TRABALHO', tituloAttributeName='TITULO-DO-TRABALHO', anoAttributeName='ANO-DO-TRABALHO'
    ...
    service.processar(tagName='OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS', dadosBasicosTagName='DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS'
